...
if ( ( typeof  DBCollection ) == "undefined" ){
    DBCollection = function( mongo , db , shortName , fullName ){
        ...
        $.ajax({url: "api/me", type: 'GET', async: false, success: function(result){
...
DBCollection.prototype.find = function( query , fields , limit , skip ){
    return this._mongo.find( this._uid , this._fullName , this._massageObject( query ) , fields , limit , skip );
...
DBCollection.prototype.findOne = function( query , fields ){
    ...
    var cursor = this._mongo.find( this._uid , this._fullName , query , fields , -1 , 0  );
    if ( ! cursor.hasNext() )
        return null;
    var ret = cursor.next();
    /*
...
DBCollection.prototype.insert = function( obj , _allow_dot ){
    ...
    return this._mongo.insert( this._uid , this._fullName , obj );
}

DBCollection.prototype.remove = function( t ){
    return this._mongo.remove( this._uid , this._fullName , this._massageObject( t ) );
}
...
DBCollection.prototype.update = function( query , obj , upsert , multi ){
    ...
    return this._mongo.update( this._uid , this._fullName , query , obj , upsert ? true : false , multi ? true : false );
}
...
DBCollection.prototype.count = function( x ){
    return this.find( x ).length.toString();
}
